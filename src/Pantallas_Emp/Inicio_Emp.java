...
public class Inicio_Emp extends javax.swing.JFrame implements Runnable {
    ...
    private void initComponents() {
        ...
        Menu.add(lbl_cliente, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 250, 217, 40));
        ...
        Menu.add(lbl_devoluciones, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 200, 216, 40));
        ...
        Menu.add(lbl_proveedores, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 300, 200, 40));
        ...
        Menu.add(lbl_informacion, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 216, 50));
    ...
    private void lbl_prestamoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_prestamoMouseClicked
        Prestamo_Emp pre = new Prestamo_Emp();
        pre.setSize(669, 503);
        pre.setLocation(0, 0);
    ...
    private void lbl_clienteMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_clienteMousePressed
        Cliente_Emp us = new Cliente_Emp();
        us.setSize(669, 503);
        us.setLocation(0, 0);
    ...
    private void lbl_menuMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_menuMouseClicked
        InicioMenu_Emp im = new InicioMenu_Emp();
        im.setSize(669, 503);
        im.setLocation(0, 0);
    ...
    private void lbl_devolucionesMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_devolucionesMousePressed
        Devoluciones_Emp dev = new Devoluciones_Emp();
        dev.setSize(669, 503);
        dev.setLocation(0, 0);
    ...
    private void lbl_proveedoresMousePressed(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbl_proveedoresMousePressed
        Proveedor_Emp prov = new Proveedor_Emp();
